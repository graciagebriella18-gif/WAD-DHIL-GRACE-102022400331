                        ...
                        <?php else: ?>
                            <?php foreach ($movies as $i => $movies): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($movies['genre']) ?></td>
                                    <td><?= htmlspecialchars($movies['director']) ?></td>
                                    <td class="text-center"><?= htmlspecialchars($movies['release_year']) ?></td>
                                    <td class="text-center">
                                        <a href="form_detail_movie.php?id=<?= $movies['id'] ?>" class="btn btn-sm btn-outline-light">Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
